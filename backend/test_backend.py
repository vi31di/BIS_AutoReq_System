...
async def verify_supersession_caching():
    ...
    async with DBConnection() as db:
        ...
        await db.execute("UPDATE is_documents SET is_current = 0, superseded_by = 'IS694-2026' WHERE document_address = 'IS694-2010'")
        ...
        await db.execute("UPDATE is_documents SET is_current = 1, superseded_by = NULL WHERE document_address = 'IS694-2010'")
